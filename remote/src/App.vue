...
<template>
  <div
    style="background: #1f2124; boxShadow: 0 0 20px rgba(0, 0, 0, 0.4); borderRadius: 5px; margin: 20px 20px 20px 20px;width: 250px;padding: 20px;textAlign: center;color: white;float: left;"
    data-e2e="APP__CARD">
    <div className='icon'>
      <svg enableBackground='new 0 0 512 512' height='100px' width='100px' id='Layer_1' version='1.1'
        viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg' data-e2e="CLOUD__SYMBOL">
        <path
